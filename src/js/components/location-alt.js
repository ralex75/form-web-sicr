...
export class Location{
    ...
    mounted(){
        ...
        document.querySelector("#up").addEventListener('click',ev=>{this.showPrevElement(ev)})
        document.querySelector("#down").addEventListener('click',ev=>{this.showNextElement(ev)})
    ...
    showPrevElement()
    {
        ...
        if(el!=null && el.previousElementSibling)
        {
            el.previousElementSibling.className='form_col active'
            el.className='form_col inactive'
        }
    ...
    showNextElement()
    {
        ...
        if(el!=null)
        {
            let select = el.nextElementSibling.querySelector("select")
            if(select && !select.disabled)
            {
                el.nextElementSibling.className='form_col active'
                el.className='form_col inactive'
            }
        }
